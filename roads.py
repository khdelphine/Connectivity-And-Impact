...
# *********
# Option switches
# Remove from the mxd document all intermediary layers generated by the process
REMOVE_INTERMEDIARY_LAYERS_OPTION = "yes" # or "no"
# Avoid recomputing the time-consuming zonal statistics as table:
COMPUTE_ONLY_FINAL_SCORES_OPTION = "yes" # or "no"
...
if COMPUTE_ONLY_FINAL_SCORES_OPTION == "no":
    prep_gdb()
